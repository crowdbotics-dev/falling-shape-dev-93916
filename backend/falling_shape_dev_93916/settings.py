"""
Django settings for falling_shape_dev_93916 project.
...
ROOT_URLCONF = 'falling_shape_dev_93916.urls'
...
WSGI_APPLICATION = 'falling_shape_dev_93916.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_shape_dev_93916 API",
    "DESCRIPTION": "API documentation for falling_shape_dev_93916 App",
    "VERSION": "v1",
}
